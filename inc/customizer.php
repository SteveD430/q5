...
function q5_customize_register( $wp_customize ) {
	...
	$wp_customize->add_section('q5_section_site_page', array(
		'title'			=> __( 'Site Pages', 'q5'),
	...
	$image_upload_control = new WP_Customize_Image_Control ($wp_customize,
		...
		array('settings'	=> 'q5_setting_site_page_image',
			  'section'		=> 'q5_section_site_page',
			  'label'		=> __('Site Page\'s Background image', 'q5'),
			  'description'	=> __('Select the image to be used as the back-drop on the site-pages', 'q5')
			  )
		);
	...
	if ( isset( $wp_customize->selective_refresh ) ) {
		$wp_customize->selective_refresh->add_partial(
			...
			array(
				...
				'render_callback'     => 'q5_customize_partial_blogname',
			)
		);
		$wp_customize->selective_refresh->add_partial(
			'blogdescription',
			array(
				...
				'container_inclusive' => false,
				'render_callback'     => 'q5_customize_partial_blogdescription',
			)
		);
	}
	...
	$wp_customize->add_setting(
		...
		array(
			'default'           => 'default',
			'sanitize_callback' => 'q5_sanitize_color_scheme',
			'transport'         => 'postMessage',
		)
	);
	...
	$wp_customize->add_control(
		'color_scheme',
		array(
			'label'    => __( 'Base Color Scheme', 'q5' ),
			'section'  => 'colors',
			'type'     => 'select',
			'choices'  => q5_get_color_scheme_choices(),
			'priority' => 1,
		)
	);
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
			...
			'sidebar_textcolor',
			array(
				'label'       => __( 'Header and Sidebar Text Color', 'q5' ),
				'description' => __( 'Applied to the header on small screens and the sidebar on wide screens.', 'q5' ),
				'section'     => 'colors',
			)
		)
	);
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
			...
			'header_background_color',
			array(
				'label'       => __( 'Header and Sidebar Background Color', 'q5' ),
				'description' => __( 'Applied to the header on small screens and the sidebar on wide screens.', 'q5' ),
				'section'     => 'colors',
			)
		)
 ...
 * @see q5_customize_register()
 *
 * @return void
 */
function q5_customize_partial_blogname() {
	bloginfo( 'name' );
}
 ...
 * @return void
 */
function q5_customize_partial_blogdescription() {
 ...
 *
 * Can be filtered with {@see 'q5_color_schemes'}.
 *
...
if ( ! function_exists( 'q5_get_color_scheme' ) ) :
	/**
	 ...
	 */
	function q5_get_color_scheme() {
		$color_scheme_option = get_theme_mod( 'color_scheme', 'default' );
		$color_schemes       = q5_get_color_schemes();
...
endif; // q5_get_color_scheme

if ( ! function_exists( 'q5_get_color_scheme_choices' ) ) :
	/**
	 ...
	 */
	function q5_get_color_scheme_choices() {
		$color_schemes                = q5_get_color_schemes();
...
endif; // q5_get_color_scheme_choices

if ( ! function_exists( 'q5_sanitize_color_scheme' ) ) :
	/**
	 ...
	 */
	function q5_sanitize_color_scheme( $value ) {
		$color_schemes = q5_get_color_scheme_choices();
...
endif; // q5_sanitize_color_scheme
...
function q5_color_scheme_css() {
	...
	$color_textcolor_rgb         = q5_hex2rgb( $color_scheme[3] );
	$color_sidebar_textcolor_rgb = q5_hex2rgb( $color_scheme[4] );
	$colors                      = array(
	...
	$color_scheme_css = q5_get_color_scheme_css( $colors );

	wp_add_inline_style( 'q5-style', $color_scheme_css );
}
add_action( 'wp_enqueue_scripts', 'q5_color_scheme_css' );
 ...
 * @since Twenty Fifteen 1.0
 */
function q5_customize_control_js() {
	...
	wp_localize_script( 'color-scheme-control', 'colorScheme', q5_get_color_schemes() );
}
add_action( 'customize_controls_enqueue_scripts', 'q5_customize_control_js' );
 ...
 * @since Twenty Fifteen 1.0
 */
function q5_customize_preview_js() {
	wp_enqueue_script( 'q5-customize-preview', get_template_directory_uri() . '/js/customize-preview.js', array( 'customize-preview' ), '20141216', true );
}
add_action( 'customize_preview_init', 'q5_customize_preview_js' );
 ...
 */
function q5_get_color_scheme_css( $colors ) {
 ...
 * @since Twenty Fifteen 1.0
 */
function q5_color_scheme_css_template() {
	$colors = array(
	...
	?>
	<script type="text/html" id="tmpl-q5-color-scheme">
		<?php echo q5_get_color_scheme_css( $colors ); ?>
	</script>
	<?php
}
add_action( 'customize_controls_print_footer_scripts', 'q5_color_scheme_css_template' );
