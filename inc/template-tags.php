...
if ( ! function_exists( 'q5_posted_on' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time.
	 */
	function q5_posted_on() {
...
if ( ! function_exists( 'q5_posted_by' ) ) :
	/**
	 * Prints HTML with meta information for the current author.
	 */
	function q5_posted_by() {
		$byline = sprintf(
...
if ( ! function_exists( 'q5_entry_footer' ) ) :
	/**
	 * Prints HTML with meta information for the categories, tags and comments.
	 */
	function q5_entry_footer() {
...
if ( ! function_exists( 'q5_post_thumbnail' ) ) :
	/**
