<?php
/**
 * Custom Header functionality for Q5
 *
 * @package WordPress
 * @subpackage Q5
 * @since Q5 1.0
 ...
 *
 * @uses q5_header_style()
 */
function q5_custom_header_setup() {
	...
	add_theme_support(
		'custom-header',
		apply_filters(
			'q5_custom_header_args',
			array(
				'default-image' 	=> get_template_directory() . 'img/default-logo.gif',
				'default-text-color' => $default_text_color,
				'wp-head-callback'   => 'q5_header_style',
				'width'              => 1000,
				'height'             => 250,
				'flex-width'		=> true,
				'flex-height'		=> true,
...
add_action( 'after_setup_theme', 'q5_custom_header_setup' );
...
if ( ! function_exists( 'q5_header_style' ) ) :
	/**
	 * Styles the header image and text displayed on the blog.
	 *
	 * @since Twenty Fifteen 1.0
	 *
	 * @see q5_custom_header_setup()
	 */
	function q5_header_style() {
 ...
 */
function q5_header_background_color_css() {
	$color_scheme            = q5_get_color_scheme();
...
add_action( 'wp_enqueue_scripts', 'q5_header_background_color_css', 11 );
 ...
 * @since Twenty Fifteen 1.0
 */
function q5_sidebar_text_color_css() {
	$color_scheme       = q5_get_color_scheme();
	...
	// If we get this far, we have custom styles. Let's do this.
	$sidebar_link_color_rgb     = q5_hex2rgb( $sidebar_link_color );
...
add_action( 'wp_enqueue_scripts', 'q5_sidebar_text_color_css', 11 );
